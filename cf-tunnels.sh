...
if [ "$CHOICE" == "1" ]; then
    ...
    curl -L 'https://alist.xiercloud.top/d/%E5%85%B1%E4%BA%AB%E6%96%87%E4%BB%B6%E5%A4%B9/cloudflared-linux-amd64?sign=VKAOaypgiUl6CyCvGOi4FU4gPsihqy8jsErI2d3TjXM=:0' -o /usr/bin/cloudflared
